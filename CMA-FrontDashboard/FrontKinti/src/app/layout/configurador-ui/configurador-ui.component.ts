...
@Component({
  selector: 'app-configurator-ui',
  imports: [CommonModule, FormsModule, SelectButtonModule,
    DrawerModule, ToggleSwitchModule, RadioButtonModule],
  templateUrl: './configurador-ui.component.html',
})
export class ConfiguradorUIComponent implements OnInit {
